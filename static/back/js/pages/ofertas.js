    ...
    return {
        init: function (csrf, tipo) {
            ...
            $("#grid").kendoGrid({
                        ...
                        pageable: {
                            messages: {
                                display: "{0} - {1} de {2} ofertas",
                                empty: "No hay ofertas",
                                page: "Página",
                                of: "de {0}",
                                itemsPerPage: "Ofertas por página",
                        ...
                        toolbar: [{ name: "create", text: "Nueva oferta" }],
                        columns: columnas
                    });

            $("#grid .k-grid-add").on("click", function (ev) {
                location.href = "/admin/nuevaoferta";
            });
        }
    }
}();